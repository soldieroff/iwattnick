...
ARM-NONE-EABI-GCC.CFLAGS ?= -pipe -Wall -Wextra -std=gnu99 \
...
$(ARM-NONE-EABI-GCC.LDSCRIPT): tibs/extra/ldscripts/$(word 7,$(STM32.MEM))_flash.ld.in
	$(ARM-NONE-EABI-GCC.CPP) $(ARM-NONE-EABI-GCC.CPPFLAGS) -P -o $@ $< \
		-DSTM32_STACK_ADDRESS=$(STM32.RAM.END) \
		-DSTM32_MIN_HEAP_SIZE=0 \
		-DSTM32_MIN_STACK_SIZE=0x200 \
